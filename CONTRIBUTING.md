...
When touching historical NanoClaw-derived code, keep changes isolated and document why the legacy path still matters. New product work should follow the greenfield docs in [docs/README.md](docs/README.md), the current audit in [docs/REFACTOR-AUDIT.md](docs/REFACTOR-AUDIT.md), and the execution protocol in [docs/PHASE5-AUTONOMOUS-PLAN.md](docs/PHASE5-AUTONOMOUS-PLAN.md).
