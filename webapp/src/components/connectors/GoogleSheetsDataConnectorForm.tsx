...
type GoogleSheetsDataConnectorFormProps = {
  mode: 'create' | 'edit';
...
export function GoogleSheetsDataConnectorForm({
  mode,
  initial,
  submitting,
  error,
  onSubmit,
  onCancel,
}: GoogleSheetsDataConnectorFormProps): JSX.Element {
