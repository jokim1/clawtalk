...
const facades = [
  ...
  },
  {
    ...
    routes: '/api/v1/talks/:talkId/runs/:runId/context|getGreenfieldRunContextRoute',
  ...
  },
  {
    ...
    tokens: 'snapshotVersion|getTalkSnapshotVersion|snapshotQueryKey|applyMessageAppendedDelta',
    imports: 'snapshotQueryKey|useTalkSnapshot|wsCacheRouter|TalkSnapshot',
    routes: 'snapshotVersion|getTalkSnapshotVersion|/api/v1/talks/:talkId/snapshot',
  ...
  },
  {
    ...
    routes: '/api/v1/talks/:talkId/policy|getGreenfieldTalkPolicyRoute|updateGreenfieldTalkPolicyRoute',
    dynamic:
  ...
  },
  {
    ...
    routes: '/api/v1/talks/:talkId/attachments|attachmentsUnavailableResponse|attachments_not_available',
    dynamic: 'attachmentIds|pendingAttachments|read_attachment|attachments_not_available',
  },
];
