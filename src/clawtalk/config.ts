...
export const SLACK_CLIENT_ID =
  process.env.SLACK_CLIENT_ID || envConfig.SLACK_CLIENT_ID || '';
export const SLACK_CLIENT_SECRET =
  process.env.SLACK_CLIENT_SECRET || envConfig.SLACK_CLIENT_SECRET || '';
export const SLACK_OAUTH_REDIRECT_URI =
  process.env.SLACK_OAUTH_REDIRECT_URI ||
  envConfig.SLACK_OAUTH_REDIRECT_URI ||
  '';
