...
| 4    | API shell/resource decomposition cleanup.                                                                                  | 🔄 Greenfield mount glue, roster mutation, and policy facade extracted; next retire remaining legacy route collisions one family at a time. |
