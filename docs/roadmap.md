...
| 4    | API shell/resource decomposition cleanup.                                                                                  | 🔄 Greenfield mount glue and roster mutation extracted; next retire remaining legacy route collisions one family at a time. |
