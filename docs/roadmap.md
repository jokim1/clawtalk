...
| 6 | Product surface completion | ✅ New Talk sheet + ⌘K command palette + Salon-native Registered Agents panel shipped (PR #550). Remaining: a standalone agent profile/detail view, Archive (needs a restore route), settings gaps (Codex-owned decomp), workspace-member management. |
