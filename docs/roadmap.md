...
| 4    | API shell/resource decomposition cleanup.                                                                                  | 🔄 Greenfield mount glue, roster mutation, policy facade, and tools routes/tool-gating snapshot extracted; next retire remaining legacy route collisions one family at a time. |
