...
| 🔄 Active next    | Retire remaining legacy API collisions: resources/connector bindings and jobs                                                                                   | Next slices                                                                                                                  |
...
2. **Port resources/connector bindings and jobs to greenfield contracts.**
