...
| 🔄 Active next    | Retire remaining legacy API collisions: resources/connector bindings; then continue webapp rewrite against the final greenfield APIs                              | Next slices                                                                                                                  |
